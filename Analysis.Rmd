...
Analyze recruit survival over time between treatments with a binomial mixed model with a success and failure vector. Plug included as a random effect due to repeated measures. 
...
The success and failure columns reflect the total survival (recruits + individuals). Generate a new success and failure column for individuals and aggregates separately. Display mean proportion aggregation for each treatment combination.  
```{r}
